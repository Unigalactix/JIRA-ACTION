...
- **Current State**:  **Met** (Visibility & Tracking).
    ...
    - **Gap**: Advanced pipeline management (retries/promotions) is still manual, but reporting is now "Agentic".
...
3.  **Add Infrastructure Skills**: Create a new library lib/azure.py or lib/k8s.py to allow the agent to run z cli or kubectl commands.
